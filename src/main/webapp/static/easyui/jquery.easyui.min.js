...
(function($) {
	...
	$.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
		...
		buttons : [ {
			...
			text : function(_94ExtA) {
				return $(_94ExtA).datebox("options").cleanText;
			},
			handler : function(_94ExtB) {
				$(_94ExtB).datebox("setValue", "");
	...
	$.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults,
			{
				...
				buttons : [ {
					...
					text : function(_94ExtC) {
						return $(_94ExtC).datetimebox("options").cleanText;
					},
					handler : function(_94ExtD) {
						$(_94ExtD).datetimebox("setValue", "");
						$(this).closest("div.combo-panel").panel("close");
					}
				}, {
					text : function(_964) {
